  ...
  useEffect(() => {
    ...
    if (enabled) {
      ...
      map.on("pm:create", async (e) => {
        ...
        const cropLabel = prompt(
          "Enter crop (Soybeans, Rice - Long Grain, etc):"
        );
        ...
        try {
          ...
          const labelValue =
            colorMode === "tech"
              ? cropLabel === "Soybeans"
                ? "SB"
                : cropLabel === "Rice - Long Grain"
                ? "RLG"
                : cropLabel === "Rice - Medium Grain"
                ? "RMG"
                : cropLabel === "Corn"
                ? "CRN"
                : cropLabel === "Wheat"
                ? "WHT"
                : ""
              : techLabel === "Roundup Ready"
              ? "RR"
              : techLabel === "Enlist"
              ? "E"
              : techLabel === "Xtend"
              ? "X"
              : techLabel === "Conventional"
              ? "C"
              : techLabel === "Clearfield/Fullpage"
              ? "CF"
              : techLabel === "Provisia/MaxAce"
              ? "PV"
              : "";
...
export default function MapLabelTester() {
    ...
    neighborPolygons.forEach((polygon) => {
      ...
      const label =
        colorMode === "tech"
          ...
          : tech === "Conventional"
          ? "C"
          : tech === "Clearfield/Fullpage"
          ? "CF"
          : tech === "Provisia/MaxAce"
          ? "PV"
          : "";
  ...
  useEffect(() => {
    const fetchVarietyInfo = async () => {
      ...
      const seedingJobs = allJobs.filter(
        (job) =>
