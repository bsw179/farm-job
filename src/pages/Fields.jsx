...
export default function Fields() {
  ...
  const handleSubmit = async (e) => {
    ...
    setNewField({ ...newField, fieldName: '', farmName: '', gpsAcres: '', fsaAcres: '', county: '', farmNumber: '', tractNumber: '', fsaFieldNumber: '', operator: '', operatorRentShare: '', operatorExpenseShare: '', landowner: '', landownerRentShare: '', landownerExpenseShare: '' });
  };
  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit} className="bg-white shadow p-4 rounded grid grid-cols-2 gap-4 text-sm">
        ...
        <button type="submit" className="col-span-2 bg-blue-700 text-white px-4 py-2 rounded shadow hover:bg-blue-800">Add Field</button>
      </form>
