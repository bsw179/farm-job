  ...
  return (
    <div className="p-6">
      <div className="flex justify-between items-center mb-4">
        ...
        <button className="text-sm bg-gray-200 px-3 py-1 rounded hover:bg-gray-300" onClick={() => navigate('/')}>← Back to Jobs</button>
      </div>
      ...
      <div className="mt-6">
        <button className="bg-blue-600 text-white px-6 py-2 rounded" onClick={handleContinue}>Create Job →</button>
      </div>
